...
mod tests {
    ...
    fn test_model_request_builder() {
        let request = ModelRequest::builder(aura_core::DEFAULT_MODEL, "You are helpful")
            .message(Message::user("Hi"))
            .max_tokens(1000)
            .temperature(0.7)
            .build();

        assert_eq!(request.model, aura_core::DEFAULT_MODEL);
    ...
    fn test_stream_accumulator_into_response() {
        ...
        assert_eq!(response.trace.model, aura_core::DEFAULT_MODEL);
